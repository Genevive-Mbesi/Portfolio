...
<h1 className=" py-10 text-1xl mx-auto font-semibold">Programming Languages</h1>
 <div className=" flex items-center mr-10">
    ...
    <div className="column-row">
    <img src={javascript} alt ='Javascript'className='w-20 rounded-full object-cover h-20 w-20 container  rounded-full p-3' />
...
<div className="column-row">
<img src={flask} alt ='Flask'className='mr-20 w-20 object-cover h-20 w-20 p-3'/>
...
<h3 className="pl-2">mySQL</h3>
    ...
    <div className="column-row"> 
<img src={postgres} alt ='Postgres'className='mr-20 w-20 object-cover p-3' />
...
<div className="column-row">  
<img src={csslogo} alt ='css'className=' mr-20 w-20 object-cover h-20 w-20 container p-3' />
<h3 className="pl-6">CSS</h3>
    </div>
<div className="column-row">   
<img src={tailwind} alt ='tailwind'className='w-20 object-cover container p-3' />
