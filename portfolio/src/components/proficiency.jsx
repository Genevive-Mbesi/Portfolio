...
<h1 className="px-20 py-10 text-1xl mx-auto font-semibold">Programming Languages</h1>
 <div className=" flex items-center mr-10">
    ...
    <div className="column-row">
    <img src={javascript} alt ='Javascript'className=' animate-spin w-20 rounded-full object-cover h-20 w-20 container  bg-indigo-400  rounded-full shadow-2xl shadow-indigo-500/50 p-3' />
...
<div className="column-row">
<img src={flask} alt ='Flask'className=' animate-spin mr-20 w-20 rounded-full object-cover h-20 w-20 container  bg-indigo-400  rounded-full shadow-2xl shadow-indigo-500/50 p-3'/>
...
<h3 className="pl-2">mySQL</h3>
    ...
    <div className="column-row"> 
<img src={postgres} alt ='Postgres'className=' animate-spin mr-20 w-20 rounded-full object-cover h-20 w-20 container  bg-indigo-400  rounded-full shadow-2xl shadow-indigo-500/50 p-3' />
...
<div className="column-row">  
<img src={csslogo} alt ='css'className='animate-spin mr-20 w-20 rounded-full object-cover h-20 w-20 container  bg-indigo-400  rounded-full shadow-2xl shadow-indigo-500/50 p-3' />
<h3 className="pl-6">CSS</h3>
    </div>
<div className="column-row">   
<img src={tailwind} alt ='tailwind'className='animate-spin w-20 rounded-full object-cover h-20 w-20 container  bg-indigo-400  rounded-full shadow-2xl shadow-indigo-500/50 p-3' />
