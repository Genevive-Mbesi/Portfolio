...
<div className=" flex items-center mr-10">
    ...
    <h4>Training : Moringa School<br></br> Course : Software Engineering <br></br>Technical Skills:JavaScript, Python, React,Flask,mySQL,PostgreSQL,Git,Html,CSS,Tailwind CSS and Bootsrap<br></br>Soft Skills :Collaboration, Leadership, Effective communication.<br></br> Graduated : November, 2023</h4>
    </div>
    </div>
</div>
</nav>
