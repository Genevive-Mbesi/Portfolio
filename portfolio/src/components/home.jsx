    ...
    <main className=' px-20 md:px-20 lg:px-40' >
      <section className=' min-h-screen ' >
        ...
        <h1 className='font-bold font-mono md:text-5xl'>Genevive<br></br>Mbesi</h1>
          <div className='flex'> 
          <img src={assets} alt ='girl'className=' motion-safe:animate-spin mx-aut0 mt-20 overflow-hidden bg-indigo-400  rounded-full shadow-2xl shadow-indigo-500/50 rounded-full w-80 h-80 md:h-96 md:w-96' />
